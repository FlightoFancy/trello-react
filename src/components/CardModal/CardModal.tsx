...
export const CardModal: React.FC<CardModalProps> = ({ cardDetail, active, setActive, removeCard, children }) => {
    ...
    return <>
        {active && <Modal ref={divRef} tabIndex={0} onKeyDown={handleKeyDown}>
            <StyledOverlay />
            <ModalContent >
